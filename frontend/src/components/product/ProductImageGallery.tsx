  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ cursor: totalImages === 1 ? (isZoomed ? 'zoom-out' : 'zoom-in') : 'default' }}
      >
...
export default function ProductImageGallery({
  ...
  const handleNextImage = () => {
    const newIndex = selectedIndex === imageUrls.length - 1 ? 0 : selectedIndex + 1
    setSelectedImage(imageUrls[newIndex] || defaultImageUrl)
    setSelectedIndex(newIndex)
    setIsZoomed(false)
  }
      ...
      <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 flex items-center justify-center min-h-[500px]">
        <div className="text-center">
          <img
            ...
            alt={buildProductImageAlt({ productName: name, categoryName, context: 'main' })}
            width={400}
            height={400}
  ...
  return (
    <>
      ...
      >
        ...
        <div className={`${isFullScreen ? 'h-full' : ''} flex flex-col lg:flex-row gap-6 lg:gap-8`}>
                  ...
                  >
                    <div className="relative w-16 h-16 lg:w-20 lg:h-20 rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-800">
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src = generateProductPlaceholder(name, 80)
                        }}
                      />
                      {selectedIndex === index && (
          ...
          <div className={`relative flex-1 ${isFullScreen ? 'h-full' : ''} order-1 lg:order-2`}>
            <div className={`${isFullScreen ? 'h-full' : 'bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900'} rounded-2xl p-4 md:p-6 lg:p-8`}>
              <div className="relative">
                ...
                <div
                  className={`relative overflow-hidden rounded-xl bg-white dark:bg-gray-900 touch-pan-y select-none ${
                    isFullScreen ? 'h-[calc(100vh-12rem)]' : 'min-h-[400px] sm:min-h-[500px] lg:min-h-[600px]'
                ...
                >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = generateProductPlaceholder(name, 600)
                    }}
                  />
                </div>
              ...
              {isFullScreen && (
                <div className="mt-6 text-center">
                  ...
                  {categoryName && (
                    <p className="text-white/70 mt-1">Category: {categoryName}</p>
                  )}
                </div>
              )}
            </div>
