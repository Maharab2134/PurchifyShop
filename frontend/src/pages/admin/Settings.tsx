...
export default function AdminSettings() {
  ...
  const {
    fields: seoPages,
    append: appendSeoPage,
    remove: removeSeoPage,
  } = useFieldArray({
        ...
        form.reset({
          ...
          topbar: {
            ...
            applyForVendorsLabel:
              tb.applyForVendorsLabel ?? "Apply for Vendors",
          ...
          animationSettings: {
            welcomeAnimation: {
              ...
              backgroundColor:
                anim.welcomeAnimation?.backgroundColor ?? "#000000",
            ...
            pageTransitionAnimation: {
              ...
              backgroundColor:
                anim.pageTransitionAnimation?.backgroundColor ?? "#000000",
              circleColor:
  ...
  const translationRows = useMemo(() => {
    ...
    const keys = Array.from(
      new Set([...Object.keys(en), ...Object.keys(bn)]),
    ).sort();
    const filtered = translationSearch.trim()
      ? keys.filter((k) =>
          k.toLowerCase().includes(translationSearch.trim().toLowerCase()),
        )
      : keys;
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        {activeTab === "general" && (
          <>
              ...
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
                ...
                <div className="p-4 sm:p-6 space-y-4">
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Bar above the main navbar: email, phone, My Wishlist, Track
                    Order. SUPARADMIN controls colors and data.
                  </p>
                  ...
                  <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                    <label className="flex items-center gap-2 cursor-pointer mb-3">
                      ...
                      />
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                        Show Apply for Vendors link (top bar)
                      </span>
                    </label>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                          Apply for Vendors label
                        </label>
                        <input
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
              ...
              <div className="p-4 sm:p-6 space-y-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Contact information used for floating contact widget and
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      />
                      <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Full WhatsApp link (e.g. https://wa.me/880100000000 or
                        https://wa.me/880100000000?text=Hello)
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Full Facebook Messenger link (e.g. https://m.me/yourpage
                        or https://m.me/yourpage?ref=welcome)
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {activeTab === "seo" && (
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
            ...
            <div className="p-4 sm:p-6 space-y-6">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Configure meta tags (title, description, keywords) for all
                pages. Set defaults that apply to all pages, or add
              ...
              <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                  Default SEO (applies to all pages)
                </h3>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Default page title (used if page-specific title is not set)
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Default meta description (used if page-specific description
                    is not set)
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Comma-separated keywords (used if page-specific keywords are
                    not set)
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Default Open Graph image URL (used for social media sharing)
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {seoPages.length === 0 ? (
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center py-4">
                    No page-specific SEO settings. Click "Add Page" to configure
                    ...
                    {seoPages.map((field, index) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <input
                            {...form.register(
                              `seoSettings.pages.${index}.path` as const,
                            )}
                            placeholder="e.g. /shop, /cart, /products/example"
                            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-500/30 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all"
                          />
                          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Exact page path (e.g. /shop, /cart,
                        ...
                        <div>
                          ...
                          <input
                            {...form.register(
                              `seoSettings.pages.${index}.title` as const,
                            )}
                        ...
                        <div>
                          ...
                          <textarea
                            {...form.register(
                              `seoSettings.pages.${index}.description` as const,
                            )}
                            placeholder="Leave empty to use default"
                            rows={2}
                            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 resize-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-500/30 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          <div>
                            ...
                            <input
                              {...form.register(
                                `seoSettings.pages.${index}.keywords` as const,
                              )}
                              placeholder="Leave empty to use default"
                              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-500/30 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all"
                            />
                          ...
                          <div>
                            ...
                            <input
                              {...form.register(
                                `seoSettings.pages.${index}.ogImage` as const,
                              )}
                              placeholder="Leave empty to use default"
                              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-500/30 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all"
                            />
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
            ...
            <div className="p-4 sm:p-6 space-y-4">
              ...
              <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-3 text-sm text-blue-800 dark:text-blue-200">
                <strong>পপআপ কখন দেখাবে:</strong> পেজ লোডের পর{" "}
                <strong>Delay Time</strong> অপেক্ষা করে পপআপ আসবে;{" "}
                <strong>Show Time</strong> ধরে থাকবে তারপর নিজে বন্ধ হবে। শুধু
                **Show On Pages**-এ বাছা পেজে (খালি থাকলে সব পেজে)। একই পেজে এক
                সেশনে একবারই দেখাবে।
              </div>
              <div className="space-y-4">
                <label className="flex items-center gap-2 cursor-pointer">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      {...form.register("popupSettings.showTime", {
                        valueAsNumber: true,
                      })}
                      type="number"
                      min={1000}
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      How long the popup stays visible (1000-30000ms)
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <input
                      {...form.register("popupSettings.delayTime", {
                        valueAsNumber: true,
                      })}
                      type="number"
                      min={0}
                    ...
                    />
                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      Delay before showing popup (0-10000ms)
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    {form.watch("popupSettings.image") && (
                      <div className="relative inline-block">
                        <img
                          src={toImageUrl(form.watch("popupSettings.image"))}
                          alt="Popup preview"
                  ...
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Upload an image for the popup product display
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Leave empty to show on all pages. Add specific page paths to
                    show only on those pages.
                  </p>
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (isAdded) {
                                ...
                                form.setValue("popupSettings.pages", [
                  ...
                  <div className="space-y-2">
                    ...
                    {(form.watch("popupSettings.pages") || []).map(
                      (_, index) => (
                        <div key={index} className="flex gap-2">
                          ...
                          <button
                            ...
                            onClick={() => {
                              const current =
                                form.watch("popupSettings.pages") || [];
                              form.setValue(
                                "popupSettings.pages",
                    ...
                    {(!form.watch("popupSettings.pages") ||
                      form.watch("popupSettings.pages").length === 0) && (
                      <p className="text-xs text-gray-400 dark:text-gray-500 italic">
                        No pages specified - popup will show on all pages
                      </p>
                    )}
                  </div>
                </div>
        ...
        {activeTab === "animation" && (
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-hidden shadow-sm">
            ...
            <div className="p-4 sm:p-6 space-y-6">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Configure welcome animation and page transition animation. Both
                use your website logo dynamically.
              </p>
              ...
              <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Shown on first visit to the website
                </p>
                <div className="space-y-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...form.register(
                        "animationSettings.welcomeAnimation.isActive",
                      )}
                      className="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500"
                    />
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.welcomeAnimation.duration",
                          {
                            valueAsNumber: true,
                            min: 100,
                            max: 30000,
                    ...
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.welcomeAnimation.backgroundColor",
                        )}
                        type="color"
                    ...
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.welcomeAnimation.circleColor",
                        )}
                        type="color"
                        className="w-full h-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 cursor-pointer"
                      />
                      <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Color of rotating circle around logo
                      </p>
                    </div>
                  </div>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...form.register(
                        "animationSettings.welcomeAnimation.showConfetti",
                      )}
                      className="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500"
                    />
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...form.register(
                        "animationSettings.pageTransitionAnimation.isActive",
                      )}
                      className="rounded border-gray-300 dark:border-gray-600 text-indigo-600 focus:ring-indigo-500"
                    />
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.pageTransitionAnimation.duration",
                          {
                            valueAsNumber: true,
                            min: 100,
                            max: 10000,
                    ...
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.pageTransitionAnimation.backgroundColor",
                        )}
                        type="color"
                        className="w-full h-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 cursor-pointer"
                      />
                    ...
                    <div>
                      ...
                      <input
                        {...form.register(
                          "animationSettings.pageTransitionAnimation.circleColor",
                        )}
                        type="color"
                        className="w-full h-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 cursor-pointer"
                      />
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-4">
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Edit EN/BN text for translation keys. Use consistent keys
                      in the UI.
                    </p>
                  </div>
                            ...
                            >
                              ...
                              <td className="py-3 pr-4">
                                <textarea
                                  ...
                                  onChange={(e) => {
                                    form.setValue(
                                      `translations.en.${selectedNamespace}.${row.key}` as const,
                                      e.target.value,
                                    );
                                  }}
                                  rows={2}
                              ...
                              <td className="py-3">
                                <textarea
                                  ...
                                  onChange={(e) => {
                                    form.setValue(
                                      `translations.bn.${selectedNamespace}.${row.key}` as const,
                                      e.target.value,
                                    );
                                  }}
                                  rows={2}
