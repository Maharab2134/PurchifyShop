  ...
  useEffect(() => {
    const loadWishlist = async () => {
      ...
      try {
        ...
        const fullProducts = (await Promise.all(productPromises)).filter(
    ...
    <MainLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 sm:py-6 lg:py-8">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-6 lg:mb-8">
            My Wishlist
          </h1>
          {loading ? (
            ...
            <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Save items you like and access them anytime.
              </p>
              <button
                type="button"
